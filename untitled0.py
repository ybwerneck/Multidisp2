...
def poisson(dl, L, q, mi_w, K):
    ...
    yb2 = [9.7,10.0]        # lower and upper limits of y defining the inner boundary region
    ...
    x = np.linspace(0,10,Nx)        # x variables in 1D
    y = np.linspace(0,10,Ny)        # y variable in 1D
    #==============================================================================
